...
?>
        ...
        <div id="page-wrapper">
            ...
            <a href="pages/ExpensesReportCSV.php?filter=<?php echo $SearchTerm; ?>" class="btn white btn-warning"><i class="glyphicon glyphicon-download-alt"></i> <?php echo $DownloadExpenseCSV; ?></a>
            <div class="row">
