...
$SignIn; ?></button>                                 <hr>
                               <a href="pages/frames.php" class="btn btn-info btn-block"> <span class="glyphicon glyphicon-pencil"></span> <?php echo
$RegisterAnAccount; ?></a>
                            </fieldset>
                        </form>
                    </div>
        ...
        <div class="row text-center">
            ...
            <small >Powered By NGANGMO JORDAN, ISMAT 2K20</small>
        </div>
    </div>
